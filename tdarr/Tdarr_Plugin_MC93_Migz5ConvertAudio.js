...
const details = () => ({
  ...
  Type: 'Audio',
  Operation: 'Transcode',
  Description: 'This plugin can convert 2.0 audio track/s to AAC, can create downmixed audio tracks and convert DTS to EAC3. \n\n',
  Version: '2.4',
...
const plugin = (file, librarySettings, inputs, otherArguments) => {
  ...
  if (inputs && inputs.aac_stereo === '' && inputs.downmix === '' && inputs.dts_flac === '') {
